...
export default function Projects({ projects }) {
  ...
  return (
    <>
      <Container>
        <Head>
          <title>Tre Gelacio - Software Developer</title>
          ...
          <meta property="og:url" content="https://tregelacio.github.io/projects" />
          <meta
            property="og:title"
          ...
          <meta
            ...
            content="https://tregelacio.github.io/projects"
          />
          <meta
        ...
        >
          <Stack spacing={5}>
            ...
            <Text fontSize={{ base: '14px', md: '16px' }}>
              ...
              heres an archive of things that Ive worked on.
            </Text>
